...
import static com.nessbit.medha.jacai.utils.CommonUtils.timeFormatter;
...
public class DialogUtils {
    ...
    public static SpotsDialog showSpotsDialog(Context context,String msg) {
        SpotsDialog spotsDialog = new SpotsDialog(context);
        spotsDialog.setTitle(msg);
        spotsDialog.setCancelable(false);
        return spotsDialog;
    }
